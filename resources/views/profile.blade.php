                ...
                <div class="profile-info" id="profile-info" style="background-image: url({{ $banner }}); background-size: cover; background-position: center">
                    ...
                    <div class="author-description">
                        <div class="post-name-experience">
                            <strong class="post-author-name">{{ auth()->user()->firstname }} {{ auth()->user()->lastname }}, {{ auth()->user()->current_position }}</strong>
                            <span>
                                <span>&nbsp;·&nbsp;</span>
                    ...
                    <form class="login__form popup__form" action="{{ route('profile.update') }}" method="post">
                      ...
                      <div class="form__input--floating">
                        <div class="form__input--floating two-column-grid-first">
                            ...
                            <input id="input--first" type="text" placeholder="" value="{{ auth()->user()->firstname }}" name="firstname">
                        </div>
                        <div class="form__input--floating two-column-grid-second">
                            ...
                            <input id="input--last" type="text" placeholder="" value="{{ auth()->user()->lastname }}" name="lastname">
                        </div>
                      </div>
                      <div class="form__input--floating">
                      ...
                      <div class="form__input--floating">
                        ...
                        <input id="input--session-price" type="text" placeholder="" value="{{ auth()->user()->session_price }}" name="session_price">
                      </div>
                      <div class="form__input--floating">
